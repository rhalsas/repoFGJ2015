...
.defines(function(){
 ...
 ig.game.spawnEntity("EntityLazor",(this.pos.x + this.size.x/2),(this.pos.y + this.size.y/2), {angle: this.angleTo(ig.game.getEntityByName("circle1")) });
 this.delayGun.set(0.2);
					...
					{
					 ig.game.spawnEntity("EntityLazor",(this.pos.x + this.size.x/2),(this.pos.y + this.size.y/2), {angle: this.angleTo(ig.game.getEntityByName("circle1"))- Math.PI/32 });
					 ig.game.spawnEntity("EntityLazor",(this.pos.x + this.size.x/2),(this.pos.y + this.size.y/2), {angle: this.angleTo(ig.game.getEntityByName("circle1")) });
					 ig.game.spawnEntity("EntityLazor",(this.pos.x + this.size.x/2),(this.pos.y + this.size.y/2), {angle: this.angleTo(ig.game.getEntityByName("circle1")) + Math.PI/32 });
					 this.delayShotGun.set(0.5);
					 }
			...
			kill: function(){
				...
				if(player2 && life > 0){life--; ig.game.spawnEntity("EntityPlayer", player2.pos.x , player2.pos.y);}
				else if(life > 0){ life--; ig.game.spawnEntity("EntityPlayer", ig.system.width/2 , ig.system.height/2);}
