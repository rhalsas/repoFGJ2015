		...
		EntityDoorTrigger = ig.Entity.extend({
			...
			checkDistance: function(){
				...
				if(!player || !player2) return;
				 ...
				 if(((this.distanceTo( ig.game.getEntityByName("player")) <= 32) || (this.distanceTo( ig.game.getEntityByName("player2")) <= 32)))
				{
					this.triggered = true;	
					this.currentAnim = this.anims.triggered;
				}
				else if(((this.distanceTo( ig.game.getEntityByName("player")) > 32) || (this.distanceTo( ig.game.getEntityByName("player2")) > 32)) ){
