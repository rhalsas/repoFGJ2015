			...
			update: function(){
				...
				if(player && player2 )
				{
					if(		(player.pos.x <  this.pos.x + this.searchRange) 
						...
						else if(		(player.pos.x <  this.pos.x + this.searchRange*0.7) 
						&& 	(player.pos.x > this.pos.x - this.searchRange*0.7)  
						&& 	(player.pos.y < this.pos.y + this.searchRange*0.7)
						&& 	(player.pos.y > this.pos.y -this.searchRange*0.7)
						){this.vel.x = 0;
							this.vel.y = 0;
					}
				...
				if(		(player.pos.x <  this.pos.x + this.searchRange*0.9) 
						&& 	(player.pos.x > this.pos.x - this.searchRange*0.9)  
						&& 	(player.pos.y < this.pos.y + this.searchRange*0.9)
						&& 	(player.pos.y > this.pos.y -this.searchRange*0.9)
						){this.vel.x = 0;
							this.vel.y = 0;
