...
.defines(function(){
		EntityPlayer2 = ig.Entity.extend({
			...
			init: function(x,y,settings){
				...
				if(!ig.global.wm )this.pad = Gamepad.getPad(this,2);
			},
			update: function(){
				
				if(!this.circle) this.circle = ig.game.getEntityByName("circle2");
...
/*
		...
		*/
			...
			for(var i = 0; i < ig.game.entities.length; i++)
				...
				ig.game.player2Spawning = true;
				ig.game.player2SpawnTimer.set(3);
